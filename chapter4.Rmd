...
From my predictions 13 + 17 + 18 + 24 = 72 were correct and 11 + 1 + 7 + 3 + 8 = 30 were incorrect, thus my LDA predictions were correct 71% of the time (or incorrect 29% of time). All the predictions for high were correct - everything that really belonged to the high class was predicted to be high, and everything predicted to be high really belongd to the high class. The other classes, on the other hand, were more problematic. E.g. out of the 25 really belonging to the class low, the LDA predicted 11 to be medium, and 1 to be medium high, correctly classifying only 13 to be low.
